  ...
  void _showSnackBar(String message, {bool isError = false}) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: isError ? Colors.redAccent : sentryBlue,
      ),
    );
  }
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      if (response.user != null && mounted) {
        ...
        // Verificar rol y navegar a la pantalla correspondiente
      ...
      _showSnackBar('Error BD: \$e', isError: true);
    } finally {
                ...
                : () {
                    if (_formKey.currentState!.validate()) {
                      if (_isStudentLogin) {
                        ...
                        // Lógica de registro Estudiante (TODO)
                        _showSnackBar('Registro aún no implementado.');
                      }
                    }
                  },
          ),
                ...
                : () {
                    if (_formKey.currentState!.validate()) {
                      if (_isExternalLogin) {
                        ...
                        // Lógica de registro Externo (TODO)
                        _showSnackBar('Registro aún no implementado.');
                      }
                    }
                  },
